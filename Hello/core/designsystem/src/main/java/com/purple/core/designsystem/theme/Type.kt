...
internal val HiTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = HiFont.line_seed,
...
object HiFont {
    ...
    val line_seed = FontFamily(
        Font(R.font.line_seed_kr_bold, FontWeight.Bold, FontStyle.Normal),
        Font(R.font.line_seed_kr_regular, FontWeight.Normal, FontStyle.Normal),
    )
