...
enum class TextType(val mainText: String, val subText: String, val isWarning: Boolean, val isButtonIcon: Boolean) {
    CHANGE_ROOM_NAME("방 이름 변경", "나에게 보이는 방 이름을 변경할 수 있어요", false, true),
    CHANGE_NAME("나의 이름 변경", "방에서 사용할 나의 이름을 변경할 수 있어요", false, true),
    CHANGE_PASSWORD("방 비밀번호 변경", "방 관리자에게만 가능한 기능이에요", false, true),
    EXIT_GROUP("방에서 나가기", "나가면 다시 초대를 받아야 들어올 수 있어요", true, false),
    DELETE_GROUP("방 삭제", "방을 삭제하면 아무것도 남지않아요....ㅠ", true, false),
